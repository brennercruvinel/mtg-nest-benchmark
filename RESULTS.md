...
verdict: confirmed for everything down to crf50, and the ladder does have a floor: txt@1 at n=1000 is 0.092 lossless, 0.096 neardup, 0.096 avif q48, 0.089 crf40, 0.093 crf50, 0.083 crf55 and 0.069 crf60, se about 0.009 each. crf50 sits +0.001 from lossless (z 0.08) and avif q48 +0.004 (z 0.31), indistinguishable from the archive; crf55 is -0.009 (z about -0.7), still inside the noise; crf60 is -0.023 (z about -1.9) with identity@1 down to 0.971, the first rung where the hit rate itself moves. so on this ruler the retrieval-only recipe holds through crf50, crf55 is the edge, crf60 is over it. drift p10 walks down the whole way (0.9968 to 0.8866) and never says where the edge is; a retrieval-only gate needs the hit@k floor, and with clip it can only see a step this large, so the stronger rulers of experiment 15 are what make it precise.
